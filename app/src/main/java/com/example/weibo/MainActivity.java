...
public class MainActivity extends AppCompatActivity  implements WbShareCallback,View.OnClickListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mCommitBtn.setOnClickListener((View.OnClickListener) this);
